...
window.IB_DATA.SPCX = {
  ...
  statusNote:
    "2026-06-12 IPO（发行价 $135，代码 SPCX），当前约 $138、市值约 $1.87T（2026-08 网络行情）。业务质量极高（Starlink 现金流 + 发射垄断 + Starship 期权），但作为新上市公司，披露仍薄、估值极端。这是一个「优秀公司，但价格是核心变量」的典型。定位为在场/观察之间，先小仓、看披露。",
  ...
  theses: [
    ...
    },
    {
      ...
      supporting: [
        { text: "可复用火箭确立了发射成本与频次优势。", tag: "FACT" },
        { text: "在商业发射市场份额领先。", tag: "FACT" },
      ],
      contrary: [
    ...
    },
    {
      ...
      supporting: [{ text: "IPO 定价 $135、当前约 $138、市值约 $1.87T (2026-08 网络行情)。", tag: "FACT" }],
      contrary: [
  ...
  risks: [
    { thesis: "Starlink 现金流", condition: "若 Starlink 用户增长停滞、或竞争把 ARPU 打下来且无法覆盖 capex，则 现金流引擎逻辑转弱。", status: "Strong" },
    { thesis: "发射 / Starship", condition: "若 Starship 长期无法进入可靠运营、且发射优势被追平，则 降本期权价值下降。", status: "Strengthening" },
    { thesis: "估值 / 锁定期", condition: "若 增长兑现不及极高预期、或锁定期抛压 + 薄披露引发重估，则 估值逻辑主导下行。", status: "Watching" },
    { thesis: "关键人 / 治理", condition: "若 治理问题或关联交易实质损害小股东利益，则 折价扩大、逻辑削弱。", status: "Watching" },
  ],
